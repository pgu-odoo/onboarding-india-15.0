...
class HospitalDoctor(models.Model):
	...
	_inherits = {'hospital.patient': 'related_patients'} #all 'hospital.patient' fields will be visiable in this  


	doctor_name  = fields.Char(string="Doctor Name")

	related_patients=fields.Many2one('hospital.patient',string="hospital.patient", auto_join="True")  #this field visiable when the debug mode is activated
