...
class SaleWizard(models.TransientModel):
    ...
    _description = 'wizard : quick sale order'
    ...
    session_student_ids = fields.Many2many(comodel_name = 'res.partner' , string ='students in current session' , related='session_id.student_ids', help='these are students currently in the session')
